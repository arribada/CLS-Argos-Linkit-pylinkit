...
class DTEParamMap():
    ...
    [ "GNSS_TRIGGER_ON_TEMP_WAKEUP", "GNP29", BOOLEAN ],
	...
	[ "AXL_SENSOR_MEASUREMENT_RANGE", "AXP08", UINT ],
    [ "AXL_SENSOR_POWER_MODE", "AXP09", UINT ],
    [ "AXL_SENSOR_X_CALIBRATION", "AXP10", FLOAT],
    [ "AXL_SENSOR_Y_CALIBRATION", "AXP11", FLOAT],
    [ "AXL_SENSOR_Z_CALIBRATION", "AXP12", FLOAT],
    ...
    [ "THERMISTOR_SENSOR_VALUE", "THP05", FLOAT ],
    [ "THERMISTOR_SENSOR_WAKEUP_THRESH", "THP03", FLOAT ],
    [ "THERMISTOR_SENSOR_WAKEUP_SAMPLES", "THP04", UINT ],
